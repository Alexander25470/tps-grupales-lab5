				...
				<div class="col-6 d-flex justify-content-center">
					<div class="input-group mb-3">
						<span class="input-group-text" id="basic-addon1">ID Cliente</span>
					  	<input class="form-control" type="number" value="${cliente.id}" disabled="true">
				...
				<div class="col-6 d-flex justify-content-center">
					<div class="input-group mb-3">
						<span class="input-group-text" id="basic-addon1">DNI</span>
					  	<input class="form-control" type="number" name="dni" value="${cliente.dni}">
					</div>
				</div>
			</div>
			...
			<div class="row d-flex justify-content-center">
				<div class="col-6 d-flex justify-content-center">
					<div class="input-group mb-3">
						...
						<select class="form-select" type="text" name="idNacionalidad" value="${cliente.nacionalidad.id}">
				...
				<div class="col-6 d-flex justify-content-center">
					<div class="input-group mb-3">
						<span class="input-group-text" id="basic-addon1">Fecha de Nacimiento</span>
					  	<input class="form-control" type="date" name="fechaNacimiento" value="<fmt:formatDate value="${cliente.fechaNacimiento}" pattern="yyyy-MM-dd"  />">
					</div>
				</div>
			</div>
