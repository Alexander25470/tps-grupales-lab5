...
<div class="container p-5">
	...
	<form action="modificarBibliotecaPut.html" method="get" id="formulario">
		<div class="row d-flex justify-content-center">
			<div class="col-6 d-flex justify-content-center">
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon1">ID Biblioteca</span>
				  	<input class="form-control" type="number" value="${biblioteca.id}" disabled/>
				  	<input name="idBiblioteca" value="${biblioteca.id}" class="d-none"/>
				</div>
			</div>
		</div>
				...
				<div class="col-6 d-flex justify-content-center">
					<div class="input-group mb-3">
						<span class="input-group-text" id="basic-addon1">Libro</span>
					  	<select class="form-select" name="ISBN" value="${biblioteca.libro.ISBN}">
			...
			<div class="col-6 d-flex justify-content-center">
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon1">Fecha de Alta</span>
				  	<input  class="form-control" type="date" name="fechaAlta" value="<fmt:formatDate value="${biblioteca.fechaDeAlta}" pattern="yyyy-MM-dd"  />">
				</div>
			</div>
		</div>
